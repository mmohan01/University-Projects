...
public class Assignment_2_Without_Strategy
{  
	// Program runs the Powers method from each cass that extends from the Superhero
	// class. The time it takes for these operations to run without using the
	// Strategy pattern is stored in nanoseconds. This is repeated 5 times and 
	// the time elapsed for each iteration is read into a text file.  
    public static void main(String args[]) 
    {
    	...
    	for (int i = 0; i < 5; i++)
    	{
	    	...
	    	try 
	    	{
				File file = new File("../../NonStrategyTimes.txt");
				...
				// Add times into "NonStrategyTimes.txt" and then close the file.
